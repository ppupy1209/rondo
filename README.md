...
```sh
curl -fsSL https://raw.githubusercontent.com/ppupy1209/rondo/v0.14.4/install.sh | sh
```
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/ppupy1209/rondo/v0.14.4/install.ps1))) -Version v0.14.4
```
