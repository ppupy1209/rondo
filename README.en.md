...
On Windows, click inside an agent pane to focus it. The keyboard fallback is `Ctrl+p`, followed by an arrow key. Rondo enables mouse input and Normal mode only for the Zellij client it launches; it does not modify your global Zellij configuration.
